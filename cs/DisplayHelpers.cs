...
namespace SDKTemplate
{
    ...
    public static class DisplayHelpers
    {
        ...
        private static bool IsSigDefinedUuid(Guid uuid)
        {
            ...
            var bluetoothBaseUuidMuse = new Guid("273E0000-4C4D-454D-96BE-F03BAC821358");
            ...
            return (baseUuid == bluetoothBaseUuid)||(baseUuid == bluetoothBaseUuidMuse);
        }
    }
